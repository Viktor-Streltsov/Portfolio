...
document.querySelector('.contacts-block .line-text').innerHTML += `<span><a href="mailto:${data.email}">Email </a></span>`
document.querySelector('.contacts-block .line-text').innerHTML += `<span><a href="${data.GIThub}">🠔 GitHub ➜</a></span>`
document.querySelector('.contacts-block .line-text').innerHTML += `<span><a href="https://t.me/${data.linkedin}"> Telegram</a></span>`
